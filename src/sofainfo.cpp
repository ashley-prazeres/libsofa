...
/************************************************************************************/
/*!
 *  @brief          Helper function to  access element [i][j][k] of a "3D array"
 * of dimensions [dim1][dim2][dim3] stored in a 1D data array
 *
 */
/************************************************************************************/
static inline const std::size_t
array3DIndex(const unsigned long i, const unsigned long j,
             const unsigned long k, const unsigned long dim1,
             const unsigned long dim2, const unsigned long dim3) {
  return dim2 * dim3 * i + dim3 * j + k;
}

/************************************************************************************/
/*!
 *  @brief          Helper function to  access element [i][j] of a "2D array" of
 * dimensions [dim1][dim2] stored in a 1D data array
 *
 */
/************************************************************************************/
 ...
 */
/************************************************************************************/
static void PrintEmitter(const sofa::File &theFile, std::ostream &output) {
  ...
  output << sofa::String::PadWith("EmitterPosition:Type") << " = "
         << sofa::Coordinates::GetName(coordinates) << std::endl;
  output << sofa::String::PadWith("EmitterPosition:Units") << " = "
         << sofa::Units::GetName(units) << std::endl;
 ...
 */
/************************************************************************************/
static void PrintReceiver(const sofa::File &theFile, std::ostream &output) {
  sofa::Coordinates::Type coordinates;
  sofa::Units::Type units;
  ...
  output << sofa::String::PadWith("ReceiverPosition:Type") << " = "
         << sofa::Coordinates::GetName(coordinates) << std::endl;
  output << sofa::String::PadWith("ReceiverPosition:Units") << " = "
         << sofa::Units::GetName(units) << std::endl;
 ...
 */
/************************************************************************************/
static void PrintListener(const sofa::File &theFile, std::ostream &output) {
  {
    sofa::Coordinates::Type coordinates;
    sofa::Units::Type units;
    ...
    output << sofa::String::PadWith("ListenerPosition:Type") << " = "
           << sofa::Coordinates::GetName(coordinates) << std::endl;
    output << sofa::String::PadWith("ListenerPosition:Units") << " = "
           << sofa::Units::GetName(units) << std::endl;
  ...
  ///
  {
    ...
    output << sofa::String::PadWith("ListenerView:Type") << " = "
           << sofa::Coordinates::GetName(coordinates) << std::endl;
    output << sofa::String::PadWith("ListenerView:Units") << " = "
           << sofa::Units::GetName(units) << std::endl;
  ...
  ///
  {
    ...
    output << sofa::String::PadWith("ListenerUp:Type") << " = "
           << sofa::Coordinates::GetName(coordinates) << std::endl;
    output << sofa::String::PadWith("ListenerUp:Units") << " = "
           << sofa::Units::GetName(units) << std::endl;
 ...
 */
/************************************************************************************/
static void PrintSource(const sofa::File &theFile, std::ostream &output) {
  ...
  output << sofa::String::PadWith("SourcePosition:Type") << " = "
         << sofa::Coordinates::GetName(coordinates) << std::endl;
  output << sofa::String::PadWith("SourcePosition:Units") << " = "
         << sofa::Units::GetName(units) << std::endl;
...
int main(int argc, char *argv[]) {
  ...
  try {
    ...
    if (isHRIR == true) {
      output << filename << " is a valid 'SimpleFreeFieldHRIR' file"
             << std::endl;
    } else {
      output << filename << " is not a valid 'SimpleFreeFieldHRIR' file"
             << std::endl;
      return 0;
    }
    ...
    output << sofa::String::PadWith("Data.SamplingRate") << " = " << sr
           << std::endl;
    output << sofa::String::PadWith("Data.SamplingRate:Units") << " = "
           << sofa::Units::GetName(units) << std::endl;
